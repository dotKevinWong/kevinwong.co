                    ...
                    <Box maxW="4xl">
                        <VStack align="left" spacing={6}>
                            ...
                            <HStack align="left" justify="center" direction="row" wrap="wrap" spacing={4} gap={2}>
                                <Button colorScheme="linkedin" leftIcon={<FaLinkedin />} as="a" href="https://linkedin.com/in/dotKevinWong" target="_blank" rel="noreferrer">LinkedIn</Button>
                                <Button colorScheme="facebook" leftIcon={<FaFacebook />} as="a" href="https://facebook.com/dotKevinWong" target="_blank" rel="noreferrer">Facebook</Button>
                                <Button colorScheme="twitter" leftIcon={<FaTwitter />} as="a" href="https://twitter.com/dotKevinWong" target="_blank" rel="noreferrer">Twitter</Button>
                                <Button colorScheme="pink" leftIcon={<FaInstagram />} as="a" href="https://instagram.com/dotKevinWong" target="_blank" rel="noreferrer">Instagram</Button>
                                <Button colorScheme="blue" leftIcon={<FaGithub />} as="a" href="https://github.com/dotKevinWong" target="_blank" rel="noreferrer">GitHub</Button>
                                <Button colorScheme="red" leftIcon={<FaYoutube />} as="a" href="https://youtube.com/c/dotKevinWong" target="_blank" rel="noreferrer">YouTube</Button>
                            </HStack>
                            <HStack>
