...
<Box>
<List.Root>
  <List.Item>Future Smart Home Capability</List.Item>
  <List.Item>Control & Customization</List.Item>
  <List.Item>Static Caching</List.Item>
  <List.Item>Increased Speed</List.Item>
</List.Root>
</Box>
